...
```{r}
SoilData_pca1filter <- Remove_NA_lines(Remove_outliers(SoilData, c(13:32)), c(13:32))

SoilData.pca1 <- prcomp(SoilData_pca1filter[,13:32], center=TRUE, scale.=TRUE)
...
```{R}
#ggbiplot(SoilData.pca1, ellipse=TRUE, groups = SoilData_pca1filter$SUBCLASS5_COASTAL)
````
